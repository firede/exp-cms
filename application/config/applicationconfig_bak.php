...
return array(
    ...
    "app" => array(//慎用
        "setup.status" => 0, //当前系统安装状态：0 未安装状态｜1 数据库已安装 ｜2 缓存已配置 ｜3 管理员帐号已设置 ｜4 完成
        /* "setup.steps_page" => array(//安装步骤中完成后下一步跳转到的页面
         * 0 => "set_db", //当从为安装的状态跳转值安装数据库状态
         * 1 => "set_cache", //只进行数据库安装成功部分则直接跳过做缓存设置
         * 2 => "set_admin", //上两部成功的情况下直接跳过之前的两部进入管理员设置
         * 3 => TRUE, //管理员安装成功说明已经安装成功了
         * 4 => TRUE, //完成状态
         * ) */
