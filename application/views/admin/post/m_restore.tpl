<div id="subviewMRestore" class="subview">
	<div class="desc">你确定要<strong>还原</strong>这些文章么？</div>
	<div class="clearfix">
...
$(document).ready(function () {
	...
	if (id === '') {
		container.html('<div>请先钩选需要<strong>还原</strong>的文章再进行操作。</div>');
	}

	submit.click(function () {
		$.post(
			baseUrl + 'admin/post/m_restore_post',
			{ 'id': id },
			function(obj){
				if (obj.success == true) {
