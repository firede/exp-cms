...
<div class="grid_21">
	<ul class="setting-menu clearfix radius_all">
		...
		<li class="selected"><a href="<{$BASE_URL}>admin/setting/advanced">高级选项设置</a></li>
	</ul>
	<h2 class="form-title">高级选项设置</h2>
	<div class="form-table-wrap">
		<form action="<{$BASE_URL}>admin/setting/advanced_post" method="POST">
