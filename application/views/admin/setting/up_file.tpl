...
<div class="grid_21">
	<ul class="setting-menu clearfix radius_all">
		...
		<li class="selected"><a href="<{$BASE_URL}>admin/setting/up_file">文件上传设置</a></li>
	...
	<h2 class="form-title">文件上传设置</h2>
	<div class="form-table-wrap">
		<form action="<{$BASE_URL}>admin/setting/up_file_post" method="POST">
