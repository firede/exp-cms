...
class Model_User extends Model_Base {
    ...
    public function post_validate($post, $form, $legal_fileds, $type=NULL) {
        ...
        //email 密码检测
        if (in_array("email", $legal_fileds)) {
        ...
        //status 密码检测
        if (in_array("status", $legal_fileds)) {
        ...
        //user_type 密码检测
        if (in_array("user_type", $legal_fileds)) {
