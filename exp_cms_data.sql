...
INSERT INTO `post` ( `uuid`, `title`, `cate_id`, `pub_time`, `update_time`, `pre_content`, `content`, `user_id`, `status`, `read_count`, `operation_id`, `reference`, `source`, `operation_desc`, `flag`, `swap`) VALUES
( '3', '这里是标题', 1, '2010-11-24 08:18:46', '0000-00-00 00:00:00', '这是内容，我要预览效果啊', '', '3', 1, 0, 'admin', NULL, NULL, 'xiaodang', '0,', '2'),
( '3', '换个标题名', 1, '2010-11-24 08:40:57', '0000-00-00 00:00:00', '33', 'lalala', '3', 0, 0, '3', NULL, NULL, NULL, '0,', ''),
( '3', '少林足球中，火云邪神的大绝招是啥？', 1, '2010-11-24 08:40:59', '0000-00-00 00:00:00', '33', 'lalala', '3', 0, 0, '3', NULL, NULL, NULL, '0,', ''),
( '3', '教你怎样才能百分百发挥出如来神掌的威力', 1, '2010-11-24 08:41:00', '0000-00-00 00:00:00', '33', 'lalala', '3', 2, 0, '3', NULL, NULL, NULL, '0,', ''),
( '3', '足球比赛中如何施展功夫而不被罚黄牌', 1, '2010-11-24 08:41:02', '0000-00-00 00:00:00', '参考中国足球', 'lalala', '3', 0, 0, '3', NULL, NULL, NULL, '0,', ''),
( '3', '少林足球中，谁演的那个尼姑', 1, '2010-11-24 08:41:04', '0000-00-00 00:00:00', '33', 'lalala', '3', 5, 0, '3', NULL, NULL, NULL, '0,', ''),
('3', '不是吧，标题全是3', 1, '2010-11-24 08:41:59', '0000-00-00 00:00:00', '33', 'lalala', '3', 0, 0, '3', NULL, NULL, NULL, '0,', ''),
( '3', '一二三四五六七八九十一二三四五六七八九十测试', 1, '2010-11-24 09:15:07', '0000-00-00 00:00:00', '测试', 'lalala', '3', 0, 1, '3', NULL, NULL, NULL, '0,', ''),
( '3', '没有标题可不行啊', 1, '2010-11-24 09:15:22', '0000-00-00 00:00:00', '33', 'lalala', '3', 1, 1, '3', NULL, NULL, NULL, '1,2,3', ''),
('3', '文章一定得要有标题', 1, '2010-11-25 08:18:46', '0000-00-00 00:00:00', '这是内容', 'pre内容', '1', 1, 20, 'admin', NULL, NULL, 'firede', '0,1,2', '2'),
( '3', '蓝蓝路与上校间不得不说的故事', 1, '2010-11-26 08:18:46', '0000-00-00 00:00:00', '这是内容', 'pre内容', '1', 1, 20, 'admin', NULL, NULL, 'firede', '0,3', '2'),
( '3', '教你如何唱蓝蓝路之歌', 1, '2010-11-27 08:18:46', '0000-00-00 00:00:00', '这是内容', 'pre内容', '1', 1, 20, 'admin', NULL, NULL, 'firede', '0,2,3', '2'),
( '3', '神说，要有光', 1, '2010-11-28 08:18:46', '0000-00-00 00:00:00', '这是内容', 'pre内容', '1', 1, 20, 'admin', NULL, NULL, 'firede', '0,1', '2'),
( '3', '制造测试数据的全攻略', 1, '2010-11-29 08:18:46', '0000-00-00 00:00:00', '这是内容', 'pre内容', '1', 1, 20, 'admin', NULL, NULL, 'firede', '0,1,3', '2'),
('3', '文章一定得要有标题', 1, '2010-11-25 08:18:46', '0000-00-00 00:00:00', '这是内容', 'pre内容', '1', 1, 20, 'admin', NULL, NULL, 'firede', '0,3', '2'),
('3', '一二三四五六七八九十一二三四五六七八九十测试', 1, '2010-11-26 08:18:46', '0000-00-00 00:00:00', '这是内容', 'pre内容', '3', 1, 20, 'admin', NULL, NULL, 'firede', '0,', '2'),
( '3', '教你如何唱蓝蓝路之歌', 1, '2010-11-27 08:18:46', '0000-00-00 00:00:00', '这是内容', 'pre内容', '1', 1, 20, 'admin', NULL, NULL, 'firede', '0,', '2'),
('3', '神说，要有光', 1, '2010-11-28 08:18:46', '0000-00-00 00:00:00', '这是内容', 'pre内容', '1', 1, 20, 'admin', NULL, NULL, 'firede', '0,1,3', '2'),
( '3', '制造测试数据的全攻略', 1, '2010-11-29 08:18:46', '0000-00-00 00:00:00', '这是内容', 'pre内容', '3', 1, 20, 'admin', NULL, NULL, 'firede', '0,1,3', '2'),
( '3', '文章一定得要有标题', 1, '2010-11-25 08:18:46', '0000-00-00 00:00:00', '这是内容', 'pre内容', '1', 1, 20, 'admin', NULL, NULL, 'firede', '0,3', '2'),
( '3', '蓝蓝路与上校间不得不说的故事', 1, '2010-11-26 08:18:46', '0000-00-00 00:00:00', '这是内容', 'pre内容', '3', 1, 20, 'admin', NULL, NULL, 'firede', '0,', '2'),
('3', '教你如何唱蓝蓝路之歌', 1, '2010-11-27 08:18:46', '0000-00-00 00:00:00', '这是内容', 'pre内容', '1', 1, 20, 'admin', NULL, NULL, 'firede', '0,2,3', '2'),
( '3', '神说，要有光', 1, '2010-11-28 08:18:46', '0000-00-00 00:00:00', '这是内容', 'pre内容', '1', 1, 20, 'admin', NULL, NULL, 'firede', '0,1,3', '2'),
( '3', '制造测试数据的全攻略', 1, '2010-11-29 08:18:46', '0000-00-00 00:00:00', '这是内容', 'pre内容', '3', 1, 20, 'admin', NULL, NULL, 'firede', '0,1,3', '2'),
( '3', '文章一定得要有标题', 1, '2010-11-25 08:18:46', '0000-00-00 00:00:00', '这是内容', 'pre内容', '1', 1, 20, 'admin', NULL, NULL, 'firede', '0,3', '2'),
('3', '蓝蓝路与上校间不得不说的故事', 1, '2010-11-26 08:18:46', '0000-00-00 00:00:00', '这是内容', 'pre内容', '3', 1, 20, 'admin', NULL, NULL, 'firede', '0,2,', '2'),
( '3', '教你如何唱蓝蓝路之歌', 1, '2010-11-27 08:18:46', '0000-00-00 00:00:00', '这是内容', '', '1', 3, 20, 'admin', NULL, NULL, 'firede', '0,2,3', '2'),
( '3', '神说，要有光', 1, '2010-11-28 08:18:46', '1990-01-01 00:00:00', '这是内容', 'pre内容', '1', 3, 20, 'admin', NULL, NULL, 'firede', '0,1,3', '2'),
( '3', '制造测试数据的全攻略', 1, '2010-11-29 08:18:46', '1990-01-01 00:00:00', '这是内容', 'pre内容', '3', 3, 20, 'admin', NULL, NULL, 'firede', '0,1,3', '2'),
( '3', '文章一定得要有标题', 1, '2010-11-25 08:18:46', '1990-01-01 00:00:00', '这是内容', '', '1', 3, 20, 'admin', NULL, NULL, 'firede', '0,3', '2'),
( '3', '蓝蓝路与上校间不得不说的故事', 1, '2010-11-26 08:18:46', '0000-00-00 00:00:00', '这是内容', 'pre内容', '3', 1, 20, 'admin', NULL, NULL, 'firede', '0,2,', '2'),
( '3', '教你如何唱蓝蓝路之歌', 1, '2010-11-27 08:18:46', '0000-00-00 00:00:00', '这是内容', 'pre内容', '1', 1, 20, 'admin', NULL, NULL, 'firede', '0,2,3', '2'),
( '3', '神说，要有光', 1, '2010-11-28 08:18:46', '0000-00-00 00:00:00', '这是内容', 'pre内容', '1', 1, 20, 'admin', NULL, NULL, 'firede', '0,1,3', '2'),
( '3', '制造测试数据的全攻略', 1, '2010-11-29 08:18:46', '0000-00-00 00:00:00', '这是内容', 'pre内容', '3', 1, 20, 'admin', NULL, NULL, 'firede', '0,1,3', '2');
