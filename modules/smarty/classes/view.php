...
class View extends Kohana_View {
    ...
    protected $_enable_themes = FALSE;

    public function __construct($file = null, array $data = null, $enable_themes=FALSE) {
        $token = Kohana::$profiling ? Profiler::start('renderer', 'new kohana view') : false;

        $this->_config = Kohana::config('render');
        $this->_enable_themes=$enable_themes;
        parent::__construct($file, $data, $enable_themes);
